...
namespace QuickConfig
{
    public class EngineDatabase
    {
        ...
        public string importGDB2SDE(IWorkspace workspace, IFeatureWorkspace featureworkspace, IFeatureDataset featuredataset, string gdpfolderPath, int CoordinateSystem, string user)
        {
            string ans = "";
            if (gdpfolderPath != "")
            {
        ...
        public string exportSDE2GDB(IWorkspace workspace, IFeatureWorkspace featureworkspace, IFeatureDataset featuredataset, string gdpfolderPath, int CoordinateSystem, string user)
        {
            string ans = "";
            if (gdpfolderPath != "")
            {
